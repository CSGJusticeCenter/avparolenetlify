...
htmltools::div(
  ...
  div(
    ...
    div(
      HTML("Currently Eligible for Parole but<br>in Prison (1-25 Year Sentences)"),
      id = "bold-text"
    )
  ),
  div(
    ...
    div(
      HTML("Eligible for Parole in the next 1-5 years<br>and in Prison (1-25 Year Sentences)"),
      id = "bold-text"
    )
  )
)
...
div(id = "body-section", br(),
    div(id = "big-section-title", "People in Prison Currently Eligible for Parole (1-25 Year Sentences) in 2020"))
```
...
<br><br>
<small><i>Notes: The prison population with sentence lengths between 1-25 years and the parole eligible prison population only includes people incarcerated for a new crime.</i></small>
