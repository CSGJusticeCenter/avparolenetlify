...
# Date last updated: January 20, 2025 (MAR)
# Description:
...
required_packages <- c(
  ...
  "downloadthis", "readxl", "memoise", "tidylog", "pagedown" #, "purr"
)
...
render_image <- JS("
  function(){
    this.renderer.image('https://avparoleproject.netlify.app/img/csg-logo.png', 10, this.chartHeight - 50, 140.1, 30)
    .add();
  }")
