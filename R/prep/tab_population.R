...
all_waffle_population_race <- fnc_hc_waffle(current_ped_race, "race", colors_race, "Race and Ethnicity", accessibility_text_race)

# Prepare the data for sex
current_ped_sex <- fnc_prepare_population_data(ncrp_yearendpop, sex)
...
all_waffle_population_sex <- fnc_hc_waffle(current_ped_sex, "sex", colors_sex, "Gender", accessibility_text_sex)

# Prepare the data for age
current_ped_ageyrend <- fnc_prepare_population_data(ncrp_yearendpop, ageyrend) |>
...
all_waffle_population_ageyrend <- fnc_hc_waffle(current_ped_ageyrend, "ageyrend", colors_age, "Current Age", accessibility_text_age)
...
# # Prepare the data for sex
# current_population_sex <- bjs_prison_pop_by_gender_2022
#
# # Colors for sex
# colors_sex <- c(color1, color3)
#
...
#
# # Create the charts for sex
# all_waffle_population_sex <- fnc_hc_waffle(current_population_sex, "gender", colors_sex, "Gender", accessibility_text_sex)
#
# # # Prepare the data for age
# # current_population_age <- DATA
# #
# # # Colors for age
# # colors_age <- c(color1, color2, color3, color5, color4)
# #
...
# # accessibility_text_age <- "TBD"
# # # Create the charts for age
# # all_waffle_population_age <- fnc_hc_waffle(current_population_age, "age", colors_age, "Current Age", accessibility_text_age)
#
# # Display the chart for Georgia as an example
# all_waffle_population_race$Georgia
# all_waffle_population_sex$Georgia
