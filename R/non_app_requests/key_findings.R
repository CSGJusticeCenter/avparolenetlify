...
# #
# # # Get NCRP data for people past parole eligibility
...
# #   filter(race != "Unknown") |>
# #   # Filter to White, Hispanic, and Black for most states
# #   filter(
# #     state %in% states_use_other_race_eth$state |
# #       (!state %in% states_use_other_race_eth$state &
# #          race %in% c("White, non-Hispanic", "Hispanic, any race", "Black, non-Hispanic"))
# #   ) |>
# #   # Ensure negative years_to_estimated_pey are treated as positive (past PE year)
...
# #
# # # Identify states using 2018 data
# # states_using_2018_data <- avg_past_pe_race_by_state |>
# #   filter(rptyear == 2018) |>
# #   pull(state) |>
# #   unique()
# #
# # # Calculate weighted averages across states by race
...
# #
# # cat("States Abolished Parole (", count_abolished_states, "):",
# #     paste(states_abolished_parole$state, collapse = ", "), "\n")
#
# # ---------------------------------------------------------------------------- #
# # Years Spent in Prison Past Parole Eligibility
#
