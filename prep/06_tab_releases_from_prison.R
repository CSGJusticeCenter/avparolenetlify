...
# Highcharts for:
# Timing of release overall and by offense type
# Released before, on, or after PE year

# Obtained from NCRP releases (2020)

################################################################################

# Get number and prop of people by release year, parole eligibility year
...
# Highcharts for:
# Length of stay overall and by offense type
# Less than or full sentence length served
