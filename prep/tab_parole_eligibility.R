...
all_sentence_parole_elgibility_population <- map(.x = states,  .f = function(x) {
  ...
  sentences <- paste0("In ", select_year, ", there were ", formattable::comma(df1$n, digits = 0),
                      " people were eligible for parole but still in prison for new court commitments and with original sentence lengths ranging from 1 to 24.99 years. This group made up ",
